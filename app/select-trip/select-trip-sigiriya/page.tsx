        ...
        <div className="flex-1 p-8 space-y-8 overflow-y-auto">
          ...
          >
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-gray-800">Sri Lanka Adventure 🇱🇰</h1>
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-sm">
              A UNESCO World Heritage Site rising 200 meters above jungle plains.
            </p>
            ...
            <div className="mt-6 relative overflow-hidden rounded-3xl p-6 bg-gradient-to-br from-indigo-50 via-white to-blue-50 border border-white/50 shadow-lg">
              ...
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-indigo-300/30 rounded-full blur-3xl"></div>
              ...
              <div className="flex items-center gap-3 mb-3 relative z-10">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800">Why visit Sigiriya?</h3>
                  <p className="text-xs text-gray-500">Sri Lanka’s #1 UNESCO Wonder</p>
                </div>
              </div>

              {/* description */}
              <p className="text-sm text-gray-700 leading-relaxed relative z-10">
                Known as the <span className="font-semibold text-indigo-700">“Lion Rock”</span>, Sigiriya is an ancient
                rock fortress rising above lush jungle. It combines history, nature, and adventure into one
              ...
              <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10">
                <div className="flex items-start gap-2 bg-white/60 p-3 rounded-xl shadow-sm hover:shadow-md transition">
                  ...
                  <p className="text-sm text-gray-700">Ancient Royal Palace ruins on top of the rock</p>
                </div>

                <div className="flex items-start gap-2 bg-white/60 p-3 rounded-xl shadow-sm hover:shadow-md transition">
                  <span className="text-lg">🐘</span>
                  <p className="text-sm text-gray-700">Nearby wildlife safaris & elephant sightings</p>
                </div>

                <div className="flex items-start gap-2 bg-white/60 p-3 rounded-xl shadow-sm hover:shadow-md transition">
                  <span className="text-lg">🎨</span>
                  <p className="text-sm text-gray-700">Famous Sigiriya frescoes (ancient paintings)</p>
                </div>

                <div className="flex items-start gap-2 bg-white/60 p-3 rounded-xl shadow-sm hover:shadow-md transition">
                  <span className="text-lg">🌅</span>
                  <p className="text-sm text-gray-700">Best sunrise & panoramic view in Sri Lanka</p>
                </div>
              </div>

              {/* bottom highlight */}
              <div className="mt-5 flex items-center justify-between relative z-10">
                <div className="text-xs text-gray-500">⏱ Recommended visit: 2–3 hours climb</div>
